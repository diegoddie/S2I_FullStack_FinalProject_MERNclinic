...
const DoctorCard = ({ doctor }) => {
  ...
  return (
    <div className='mx-3 mb-2'>
      <div className='relative overflow-hidden h-[250px] md:h-[290px] 2xl:h-[330px] rounded-t-xl rounded-b-md'>
        <img src={profilePicture} alt='doctor' className='w-full h-full object-cover rounded-t-xl rounded-b-md' />
      </div>
