        ...
        <div className='flex flex-col md:flex-row-reverse items-center justify-between h-full'>
          <div className='md:w-1/2 text-center xl:text-left justify-center'>
            <div className='justify-center flex items-center bg-white py-[10px] px-[20px] w-max gap-x-2 rounded-full mx-auto xl:mx-0 mb-[26px]'>
              <FaShieldHeart className='text-2xl text-pink-300 ' />
            ...
            <p className='text-xl mb-8 md:max-w-xl text-gray-600'>At MyClinic, you can book and manage your appointments with our expert doctors, putting your health journey at the forefront of innovation.</p>
            <div className='font-semibold text-2xl text-gray-800'>
              <Link to='/sign-up' className='text-white bg-[#168aad] hover:bg-[#12657f] py-2 px-4 transition-all duration-300 rounded-lg'>
                Join MyClinic
              </Link>
            </div>
          </div>
